  ...
  constructor(private directorService: DirectorService,public router: Router) { }
    ...
    schedulecourseinfor(id:any,sta:any){
        ...
        .subscribe(data => {
            ...
            if(sta=='1'){
                 ...
                 console.log(data);
                 this.cUscheduleName=resData.result.scheduleName;
            }else{
                 console.log('未开始 课表基础信息');
                 console.log(data);
                 this.nSscheduleName=resData.result.scheduleName;
            }
        });
    }
    ...
    getBasicInfo(){
        ...
        .subscribe(data => {
            ...
            let resData=eval('('+data['_body']+')');
            console.log(resData);
            this.dir_releasedlivequantity=resData.result.releasedlivequantity;
            this.dir_syncTime=resData.result.lastestSyncTime;
        });
    }
    ...
    getCommissionerList(){
        ...
        .subscribe(data =>{
            ...
            let resData=eval('('+data['_body']+')');
            console.log(resData);
            this.commissionerList=resData.result;
            let obj={
                realName:'全部',
                zhsId:'-1'
            };
    ...
    paikecountInfo(id:any){
        ...
        .subscribe(data => {
            ...
            let resData=eval('('+data['_body']+')');
            console.log(resData);
            this.dir_paikeCountInfo=resData.result;
            this.dir_paikeALL=0;
            this.dir_paikeOK=0;
