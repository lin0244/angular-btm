...
export class MainComponent implements OnInit {
    ...
    public main_role1 = false;
    public main_role2 = false;
    public main_role3 = false;
    public main_role4 = false;
    public main_roleArr = ['管理员', '运行主管', '专员','保障主管', '值班人员']; //五种角色名
    public main_role= '';
    ...
    logOut() {
        ...
        // this.login.invalidateSession()       //调退出登录接口
        // .subscribe(data => {
        //     console.log(data);
        // });
    ...
    ngOnInit(): void {
        ...
        if(this.getCookie('role') != null) {
            ...
            if(this.getCookie('role') == "0"){
                ...
                return;
            }else if(this.getCookie('role') == "1"){
                this.main_role1=true;
